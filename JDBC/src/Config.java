...
public class Config {
  ...
  private static final String DB_URL = "jdbc:mysql://localhost:8081/jdbccc";
  ...
  public static String getAllData()
  {
    ...
    try {
      ...
      String query = "SELECT invoiceNumber, customerName, NoHP, alamat,itemName, price, quantity FROM jdbcpbo";
